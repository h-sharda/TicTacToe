...
public class Bot5 extends BotFunctions {
    ...
    /* This bot is very strong (unbeatable in small board size), it moves according to the following strategy:
    ...
    6) Then it checks if the next player can perform a double fork somewhere (only checks for next player)
    7) Then it tries moving near other pieces towards the center
